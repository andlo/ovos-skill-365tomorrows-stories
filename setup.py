...
URL = "https://github.com/andlo/ovos-skill-365tomorrows-stories"
SKILL_CLAZZ = "TomorrowsStories"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-365tomorrows-stories"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Reads daily CC-licensed flash sci-fi from 365tomorrows.com aloud - provider skill for ovos-common-reading-pipeline-plugin",
    ...
    keywords="ovos skill voice assistant science fiction flash fiction storytelling",
