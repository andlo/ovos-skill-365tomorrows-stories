...
def test_danish_alias_matches_danish_phrasing(skill, monkeypatch):
    ...
    assert skill._matches_collection_hint("science fiction noveller") is True
...
def test_falls_back_to_english_for_untranslated_language(skill, monkeypatch):
    ...
    assert skill._collection_aliases == ["365 tomorrows", "three sixty five tomorrows", "tomorrows"]
